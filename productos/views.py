...
import uuid
from .forms import ProductoForm, HabitacionForm
...
def listar_productos(request):
    ...
    return render(request, 'web/listar_productos.html', data)
...
def detalles_producto(request, producto_id):
    ...
    return render(request, 'web/detalles_producto.html', {'producto': producto})
...
def crear_producto(request):
    ...
    return render(request, 'web/crear_productos.html', {'form': form})